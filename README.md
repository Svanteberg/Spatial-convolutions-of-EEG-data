...
As a measure of discontinuity, the Chebyshev distance D<sub>C</sub> was used. In this measure, neighbors of an electrode lie on the unit circle. A discontinuity was defined as when for two one-dimensional neighbors
